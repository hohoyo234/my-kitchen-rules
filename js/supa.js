...
(function(){
  ...
  const TABLES = ['kitchens','users','menu','orders','shifts','tasks','swaps','sos','alerts','reconciliations','clockins','onboarding','audit','customer_feedback','members','coupons','reservations','waitlist','inventory','verifications'];
